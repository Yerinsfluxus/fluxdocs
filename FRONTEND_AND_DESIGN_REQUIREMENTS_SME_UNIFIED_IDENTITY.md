...
## 8. Suggested sequencing for the FE / design teams

Week 1
- Design: D1 (unified login), D2 (product picker), confirm §2.2 visual decisions
- Backend: schema migration + identity endpoints

Week 2
- Design: D5–D8 (SME onboarding + KYB)
- Mobile FE: §3.1 changes (no UI shift, just API migration)
- Corporate FE: §4.1 changes (login + chrome)

Week 3
- Design: D9, D10 (SME dashboard, transfers)
- Backend: SME endpoints
- Corporate FE: SME onboarding screens

Week 4
- Corporate FE: SME dashboard + transfer screens
- Design: D3, D4, D11 (in-product switcher, add-product settings, identity settings)

Week 5 (MVP candidate)
- End-to-end testing with real flows on staging
- KYB manual-review tooling
- Soft launch with a controlled cohort

This is aggressive but parallelisable. Slips on any one track don't block the others.
